namespace ZetaHtmlEditControl.UI.Tools
{
    ...
    public partial class HtmlEditorTableNewForm : Form
    {
        ...
        internal IExternalInformationProvider ExternalInformationProvider { private get; set; }

        private string StoreID => $@"{GetType().Name}.{Name}.{Text}";
        ...
        private bool IsNew => _table == null;
        ...
        private string calculateVerticalAlignment()
        {
            ...
            return string.IsNullOrEmpty(a) ? string.Empty : $@"valign=""{a}""";
        }
